...
// 2. Run: flutter test integration_test/embedding_property_integration_test.dart -d <device_id>
//
...
void main() {
  ...
  group('Property 8 & 9: Embedding extraction and dimension consistency', () {
    test('TensorFlow Lite tests require mobile device/emulator', () {
      if (isDesktop) {
        ...
        print('3. Run: flutter test integration_test/embedding_property_integration_test.dart -d <device_id>');
        print('\nSee integration_test/README.md for detailed instructions.');
        print('=' * 80 + '\n');
      }
      
      // Always pass - this is just a placeholder that directs to integration tests
      // The actual property tests run in integration_test/embedding_property_integration_test.dart
